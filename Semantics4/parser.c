...
void compileForSt(void) {
  ...
  eat(SB_ASSIGN);
  typeExp1 = compileExpression();
  checkBasicType(typeExp1);

  eat(KW_TO);
  typeExp2 = compileExpression();
  checkBasicType(typeExp2);
  checkTypeEquality(typeExp1, typeExp2);
  checkTypeEquality(typeExp1, var->varAttrs->type);
